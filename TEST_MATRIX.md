...
Generada con IA (ver prompt 1 en [PROMPTS.md](PROMPTS.md)) y validada manualmente contra la aplicación.
...
| TC-02 (`@TC-02`) | Error | Login con credenciales inválidas | Ninguna | 1. Abrir `/` 2. Login con `standard_user` / `wrong_password` | Mensaje "Username and password do not match any user in this service"; el usuario permanece en `/` | Alta |
...
| TC-05 | Error | Usuario bloqueado (`locked_out_user`) | Mensaje "Sorry, this user has been locked out." |
